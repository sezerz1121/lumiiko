  ...
  return (
    <>
        ...
        <div className='min-h-screen flex flex-col sm:flex-row items-center justify-center w-full max-w-[90%] mx-auto gap-6 py-24 md:py-6'>
           <div className="bg-linear-to-b from-[#F9E9E5] via-[#F9E9E5] to-[#FFFFFF] w-full sm:w-72 md:w-80 lg:w-96 p-6 rounded-xl border border-[#737373]/50 overflow-hidden flex flex-col justify-between hover:scale-[1.02] transition-all duration-200 min-h-[472px] sm:min-h-[472px] md:min-h-[472px]">
