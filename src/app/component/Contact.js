...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const children = el.querySelectorAll("div, p, input, svg");
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-around items-start md:items-center w-full md:w-[90%] gap-10 md:gap-0">
        {/* Form */}
        <div className="w-full md:w-[50%] flex flex-col items-center gap-3">
          <p className="w-[80%] md:w-[40%] mb-2">Name</p>
          <input
            placeholder="Enter Name"
            className="font-albertSans font-regular border border-[#FB744F] pl-5 w-[80%] md:w-[40%] h-9 rounded-lg active:border-[#FB744F] mb-3"
          />
          ...
          <input
            ...
            className="font-albertSans font-regular border border-[#FB744F] pl-5 w-[80%] md:w-[40%] h-40 rounded-lg active:border-[#FB744F] mb-3 text-top"
          />
        ...
        {/* Info Section */}
        <div className="w-full md:w-[50%] flex flex-col items-center gap-6">
