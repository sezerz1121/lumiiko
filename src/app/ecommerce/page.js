  ...
  return (
    <>
        ...
        <div className='min-h-screen flex flex-col sm:flex-row items-center justify-center w-full max-w-[90%] mx-auto gap-6 py-24 md:py-6'>
           <div className="bg-linear-to-b from-[#BDEBBB] via-[#BDEBBB] to-[#FFFFFF] w-full sm:w-72 md:w-80 lg:w-96 p-6 rounded-xl border border-[#737373]/50 overflow-hidden flex flex-col justify-between hover:scale-[1.02] transition-all duration-200 min-h-[472px] sm:min-h-[472px] md:min-h-[472px]">
                                  ...
                                  <div className='flex flex-col gap-2'>
                                      ...
                                      <div className='flex items-start gap-2 max-w-full'>
                                      <FaCheck className='text-xl mt-1' /> 
                                      <p className='text-sm font-albertSans font-regular'>Mobile-Friendly + SEO Ready – Works on phones & helps Google rank you</p>
                                      </div>
                                      <div className='flex items-start gap-2 max-w-full'>
                                      <FaCheck className='text-xl mt-1' /> 
                                      <p className='text-sm font-albertSans font-regular'>Inventory Management Dashboard</p>
                                      </div>
                                      <div className='flex items-start gap-2 max-w-full'>
                                      <FaCheck className='text-xl mt-1' /> 
                                      <p className='text-sm font-albertSans font-regular'>Payment Gateway Integration – Accept UPI, Cards, Netbanking</p>
                                      </div>
                                       <div className='flex items-start gap-2 max-w-full'>
                                      <FaCheck className='text-xl mt-1' /> 
                                      <p className='text-sm font-albertSans font-regular'>WhatsApp Button – Chat directly with visitors</p>
                                      </div>
                                      <div className='flex items-start gap-2 max-w-full'>
                                      <FaCheck className='text-xl mt-1' /> 
                                      ...
                                      <div className='flex items-start gap-2 max-w-full'>
                                      <FaCheck className='text-xl mt-1' /> 
                                      <p className='text-sm font-albertSans font-regular'>Hosting: (~₹13,728/year)</p>
                                      </div>
                                      <div className='flex items-start gap-2 max-w-full'>
                                      <FaCheck className='text-xl mt-1' /> 
                                      ...
                                      <div className='font-albertSans font-semibold text-sm mt-4 tracking-[2%]'>
                                        Total Renewal ≈ ₹15,362/year → Just ₹42/day
                                        </div>
